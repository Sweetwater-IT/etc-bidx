...
import { AttachmentNames, QuoteStatus, TermsNames } from '@/app/quotes/(shell)/create/QuoteFormProvider';
 ...
 */
export async function fetchReferenceData(type: 'counties' | 'users' | 'owners' | 'contractors' | 'mpt equipment' | 'rental_items') {
  try {
