  ...
  public: {
    Tables: {
      ...
      associated_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "associated_items_quote_item_id_fkey"
      ...
      jobs: {
        Row: {
          archived: boolean | null
          avenue_appeals_added: boolean | null
          ...
          safety_program_added: boolean | null
          sexual_harrassment_added: boolean | null
          w9_added: boolean | null
        }
        Insert: {
          archived?: boolean | null
          avenue_appeals_added?: boolean | null
      ...
      quote_recipients: {
        Row: {
          ...
          cc: boolean | null
          created_at: string | null
          customer_contacts_id: number | null
          email: string | null
          id: number
          point_of_contact: boolean | null
          quote_id: number | null
          updated_at: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "quote_recipients_customer_contacts_id_fkey"
            columns: ["customer_contacts_id"]
            isOneToOne: false
      ...
      quotes: {
        Row: {
          bedford_sell_sheet: boolean | null
          body: string | null
          county: string | null
          created_at: string | null
          ...
          equipment_sale: boolean | null
          estimate_id: number | null
          flagging_price_list: boolean | null
          flagging_service_area: boolean | null
          flagging_terms: boolean | null
          ...
          rental_agreements: boolean | null
      ...
      quotes_customers: {
        ...
        Relationships: [
          {
            foreignKeyName: "quotes_customers_contractor_id_fkey"
            columns: ["contractor_id"]
            isOneToOne: false
            referencedRelation: "contractors"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "quotes_customers_quote_id_fkey"
            columns: ["quote_id"]
            isOneToOne: false
            referencedRelation: "quotes"
            referencedColumns: ["id"]
      ...
      sign_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "sign_orders_contractor_id_fkey"
            columns: ["contractor_id"]
            isOneToOne: false
            referencedRelation: "contractors"
            referencedColumns: ["id"]
