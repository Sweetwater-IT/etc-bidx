...
interface Props {
    ...
    //not using a set state type because it would not be able to accept undefined as a type
    //and we don't want to deal with states where localSign where would be undefined to leaving a flexible type here
    setLocalSign: (sign: PrimarySign | SecondarySign | any) => any
}
...
const DesignationSearcher = ({ localSign, setLocalSign }: Props) => {
