...
const BidSummaryStep5 = ({
    ...
    const handleSubmit = async () => {
        try {
          ...
          //   status: "Pending",
          //   contract_number: formData.adminData.contractNumber || "",
          //   owner: formData.adminData.owner || "",
          //   county: formData.adminData.county.name || "",
          //   branch: formData.adminData.county.branch || "",
          //   division: formData.adminData.division || "",
          //   estimator: formData.adminData.estimator || "",
            
          //   // Handle dates properly, ensuring letting_date is nullable
          //   start_date: formData.adminData.startDate ? new Date(formData.adminData.startDate).toISOString().split('T')[0] : new Date().toISOString().split('T')[0],
          //   end_date: formData.adminData.endDate ? new Date(formData.adminData.endDate).toISOString().split('T')[0] : new Date().toISOString().split('T')[0],
          //   letting_date: formData.adminData.lettingDate ? new Date(formData.adminData.lettingDate).toISOString().split('T')[0] : null,
