...
import { TermsNames, useQuoteForm } from "@/app/(app-shell)/quotes/create/QuoteFormProvider";
import { Textarea } from "@/components/ui/textarea";

export function QuoteTermsAndConditions() {
  const { includeTerms, setIncludeTerms, customTerms, setCustomTerms } = useQuoteForm();
  ...
  return (
    <div className="rounded-lg border p-6">
      ...
      <div className="space-y-2">
        ...
        {includeTerms['custom-terms'] &&
          <Textarea
            placeholder="Custom terms and conditions will appear below escalating costs notice."
