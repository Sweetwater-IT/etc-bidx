...
export async function POST(request: NextRequest) {
  try {
    ...
    const fieldMapping: Record<string, string> = {
      ...
      customer_job_number: 'customer_job_number',
      project_owner: 'project_owner',
      etc_job_number: 'etc_job_number',
      etc_branch: 'etc_branch',
      county: 'county',
      state_route: 'state_route',
      project_start_date: 'project_start_date',
      project_end_date: 'project_end_date',
      additional_notes: 'additional_notes',
      certified_payroll_type: 'certified_payroll_type',
      shop_rate: 'shop_rate',
      state_base_rate: 'state_base_rate',
      state_fringe_rate: 'state_fringe_rate',
      state_flagging_base_rate: 'state_flagging_base_rate',
      state_flagging_fringe_rate: 'state_flagging_fringe_rate',
      federal_base_rate: 'federal_base_rate',
      federal_fringe_rate: 'federal_fringe_rate',
      federal_flagging_base_rate: 'federal_flagging_base_rate',
      federal_flagging_fringe_rate: 'federal_flagging_fringe_rate',
      contract_status: 'contract_status',
      project_status: 'project_status',
      billing_status: 'billing_status',
      customer_pm: 'customer_pm',
      customer_pm_first_name: 'customer_pm_first_name',
      customer_pm_last_name: 'customer_pm_last_name',
      customer_pm_email: 'customer_pm_email',
      customer_pm_phone: 'customer_pm_phone',
      certified_payroll_contact: 'certified_payroll_contact',
      certified_payroll_contact_first_name: 'certified_payroll_contact_first_name',
      certified_payroll_contact_last_name: 'certified_payroll_contact_last_name',
      certified_payroll_email: 'certified_payroll_email',
      certified_payroll_phone: 'certified_payroll_phone',
      customer_billing_contact: 'customer_billing_contact',
      customer_billing_contact_first_name: 'customer_billing_contact_first_name',
      customer_billing_contact_last_name: 'customer_billing_contact_last_name',
      customer_billing_email: 'customer_billing_email',
      customer_billing_phone: 'customer_billing_phone',
      etc_project_manager: 'etc_project_manager',
      etc_billing_manager: 'etc_billing_manager',
      etc_project_manager_email: 'etc_project_manager_email',
      etc_billing_manager_email: 'etc_billing_manager_email',
