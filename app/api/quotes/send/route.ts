...
import { createQuoteEmailHtml } from "@/app/quotes/(shell)/create/ProposalHTML";
import { AdminData } from "@/types/TAdminData";
import { defaultAdminObject } from "@/types/default-objects/defaultAdminData";
import { AdminDataEntry } from "@/types/TAdminDataEntry";
import { Customer } from "@/types/Customer";
import { QuoteItem } from "@/types/IQuoteItem";
import { generateQuotePDF } from "@/lib/pdfSendQuote";
...
function mapDbQuoteItemToQuoteItem(item: any): QuoteItem {
    ...
    return {
        ...
        associatedItems: [],
        is_tax_percentage: item.is_tax_percentage,
...
export async function POST(request: NextRequest) {
    try {
        ...
        const {
            ...
            from_email,
            quote_recipients,
            quote_items: raw_quote_items,
            quotes_customers: raw_quotes_customers,
            payment_terms,
            standard_terms,
            rental_agreements,
            equipment_sale,
        ...
        const customers: Customer[] = raw_quotes_customers.map(
            (qc: any) => qc.contractors as Customer
        );
        ...
        //       content: pdfBuffer.toString("base64"), // 👈 importante
        //     },
        //   ],
        // });
