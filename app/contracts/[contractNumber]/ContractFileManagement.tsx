...
const ContractFileManagement: React.FC<ContractFileManagementProps> = ({
  ...
  const handleCountyChange = (
    countyId: string,
    fieldName: 'county' | 'countyEv' = 'county'
  ) => {
  ...
  const handleSenderChange = (
    senderName: string,
    fieldName: 'sender' | 'senderWp' | 'senderEv' = 'sender'
  ) => {
  ...
  const handleDocSave = async (
    type: 'fringe-benefits' | 'employment-verification' | 'workers-protection'
  ) => {
    if (!jobId) {
  ...
  return (
    <div className='space-y-6'>
        ...
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            <div className='space-y-2'>
              ...
              <Popover
                ...
                onOpenChange={open =>
                  setOpenStates(prev => ({ ...prev, countyEv: open }))
                }
              >
                <PopoverTrigger asChild>
                  <Button
                    ...
                    <CommandGroup className='max-h-[200px] overflow-y-auto'>
                      {counties.map(county => (
                        <CommandItem
                          ...
                          value={county.name}
                          onSelect={() =>
                            handleCountyChange(county.id.toString(), 'countyEv')
                          }
                        >
                          <Check
                            className={cn(
          ...
          <div className='space-y-2'>
            ...
            <Popover
              ...
              onOpenChange={open =>
                setOpenStates(prev => ({ ...prev, sender: open }))
              }
            >
              <PopoverTrigger asChild>
                <Button
          ...
          <div className='space-y-2'>
            ...
            <RadioGroup
              ...
              onValueChange={value => {
                ...
                setCustomLaborSelected(
                  value !== 'Labor Group 1' && value !== 'Labor Group 3'
                )
              }}
          ...
          <div className='flex justify-end gap-2'>
            ...
            <Button
              disabled={saving}
              onClick={() => handleDocSave('fringe-benefits')}
            >
              Generate Document
            </Button>
          </div>
        ...
        <div className='space-y-4'>
          <div className='space-y-2'>
            ...
            <Popover
              ...
              onOpenChange={open =>
                setOpenStates(prev => ({ ...prev, senderWp: open }))
              }
            >
              <PopoverTrigger asChild>
                <Button
                  ...
                  <CommandGroup className='max-h-[200px] overflow-y-auto'>
                    {users.map(user => (
                      <CommandItem
                        ...
                        value={user.name}
                        onSelect={() =>
                          handleSenderChange(user.name, 'senderWp')
                        }
                      >
                        <Check
                          className={cn(
          ...
          <div className='flex justify-end gap-2'>
            ...
            <Button
              disabled={saving}
              onClick={() => handleDocSave('workers-protection')}
            >
              Generate Document
            </Button>
          </div>
      ...
      <div className='rounded-lg border bg-card p-6'>
        <h3 className='text-lg font-semibold mb-4'>Employment Verification</h3>
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div className='space-y-2'>
              ...
              <Popover
                ...
                onOpenChange={open =>
                  setOpenStates(prev => ({ ...prev, senderEv: open }))
                }
              >
                <PopoverTrigger asChild>
                  <Button
                    ...
                    <CommandGroup className='max-h-[200px] overflow-y-auto'>
                      {users.map(user => (
                        <CommandItem
                          ...
                          value={user.name}
                          onSelect={() =>
                            handleSenderChange(user.name, 'senderEv')
                          }
                        >
                          <Check
                            className={cn(
          ...
          <div className='flex justify-end gap-2'>
            ...
            <Button
              disabled={saving}
              onClick={() => handleDocSave('employment-verification')}
            >
              Generate Document
            </Button>
          </div>
