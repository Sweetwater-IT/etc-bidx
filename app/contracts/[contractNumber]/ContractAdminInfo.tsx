    ...
    return (
        <div className="rounded-lg border bg-card p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <AdminInfoItem label="Start Date" value={formatDate(adminData.startDate)} />
                <AdminInfoItem label="End Date" value={formatDate(adminData.endDate)} />
                <AdminInfoItem label="Total Days" value={calculateTotalDays(adminData.startDate, adminData.endDate)} />
                <AdminInfoItem label="Bid Date" value={formatDate(adminData.lettingDate)} />
