...
export default function SignOrderTrackerPage () {
      ...
      try {
        ...
        if (data.data.signs) {
          try {
            ...
            const signItemsArray = Object.entries(signsData).map(
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      // Log success message
      console.log(
        'Successfully submitted order with ID:',
        params?.id,
  ...
  // Function to actually generate after confirmation
  ...
  // Function to actually save changes after confirmation
      ...
      <SidebarInset>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={value => {
                          setSignOrder(prev =>
                            prev ? { ...prev, shop_status: value } : null
                          )
                        }}
                      >
                        <SelectTrigger className='w-full'>
                ...
                <div className='rounded-lg border bg-card text-card-foreground shadow-sm p-4 mb-4'>
                  <div className='space-y-8'>
                    ...
                    <div className='w-full flex gap-4'>
                      <div className='flex-1'>
                        ...
                        {isCustomSign ? (
                          ...
                          <Select
                            value={newSign.designation}
                            onValueChange={value =>
                              setNewSign({ ...newSign, designation: value })
                            }
                          >
                            <SelectTrigger className='w-full'>
                      ...
                      <div className='flex-1'>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setNewSign({ ...newSign, substrate: value })
                          }
                        >
                          <SelectTrigger className='w-full'>
                    ...
                    <div className='flex items-center gap-4'>
                      {isCustomSign ? (
                        ...
                        <div className='flex-1'>
                          ...
                          <Select
                            value={
                              newSign.width && newSign.height
                                ? `${newSign.width}x${newSign.height}`
                                : undefined
                            }
                            onValueChange={value => {
                      ...
                      <div className='flex-1'>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setNewSign({ ...newSign, sheeting: value })
                          }
                        >
                          <SelectTrigger className='w-full'>
                    ...
                    <div className='flex items-center gap-4'>
                      <div className='flex-1'>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setNewSign({ ...newSign, structure: value })
                          }
                        >
                          <SelectTrigger className='w-full'>
                          ...
                          <SelectContent>
                            <SelectItem value="4' T-III RIGHT">
                              4&apos; T-III RIGHT
                            </SelectItem>
                            <SelectItem value="4' T-III LEFT">
                              4&apos; T-III LEFT
                            </SelectItem>
                            <SelectItem value="6' T-III RIGHT">
                              6&apos; T-III RIGHT
                            </SelectItem>
                            <SelectItem value="6' T-III LEFT">
                              6&apos; T-III LEFT
                            </SelectItem>
                            <SelectItem value='H-FOOT'>H-FOOT</SelectItem>
                            <SelectItem value='LOOSE'>LOOSE</SelectItem>
                            <SelectItem value="8' POST">
                              8&apos; POST
                            </SelectItem>
                            <SelectItem value="10' POST">
                              10&apos; POST
                            </SelectItem>
                            <SelectItem value="12' POST">
                              12&apos; POST
                            </SelectItem>
                            <SelectItem value="14' POST">
                              14&apos; POST
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      ...
                      <div className='flex-1'>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setNewSign({
                              ...newSign,
                              bLights: parseInt(e.target.value) || 0
                            })
                          }
                          min={0}
                          className='w-full'
                      ...
                      <div className='flex-1'>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setNewSign({
                              ...newSign,
                              covers: parseInt(e.target.value) || 0
                            })
                          }
                          min={0}
                          className='w-full'
                    ...
                    <div className='flex justify-end space-x-3 pt-2'>
                      <Button variant='outline' onClick={handleCancelAddSign}>
                        Cancel
                      </Button>
                      <Button onClick={handleSaveNewSign}>Save Sign</Button>
                    </div>
                  </div>
                </div>
              )}
                ...
                <table className='w-full border-collapse'>
                  <thead>
                    <tr className='bg-gray-50 text-sm font-medium text-gray-600'>
                      ...
                      <th className='border p-2 text-left'>Substrate</th>
                      ...
                      <tr key={item.id}>
                        ...
                        <td className='border p-2'>
                          <Input
                            ...
                            onChange={e => {
                              const updatedItems = [...signItems]
                              updatedItems[index].substrate = e.target.value
                              setSignItems(updatedItems)
                            }}
                          />
                        </td>
                          ...
                          <div className='flex items-center'>
                            <Button
                              ...
                              onClick={() => {
                                ...
                                updatedItems[index].in_stock = Math.max(
                                  0,
                                  currentValue - 1
                                )
                                setSignItems(updatedItems)
                            ...
                            <Input
                              ...
                              onChange={e => {
                                ...
                                updatedItems[index].in_stock = isNaN(value)
                                  ? 0
                                  : Math.max(0, value)
                                setSignItems(updatedItems)
                              }}
                          ...
                          <div className='flex items-center'>
                            <Button
                              ...
                              onClick={() => {
                                ...
                                updatedItems[index].order = Math.max(
                                  0,
                                  currentValue - 1
                                )
                                setSignItems(updatedItems)
                            ...
                            <Input
                              ...
                              onChange={e => {
                                const updatedItems = [...signItems]
                                const value = parseInt(e.target.value)
                                updatedItems[index].order = isNaN(value)
                                  ? 0
                                  : Math.max(0, value)
                                setSignItems(updatedItems)
                              }}
                          ...
                          <div className='flex items-center'>
                            <Button
                              ...
                              onClick={() => {
                                ...
                                updatedItems[index].make = Math.max(
                                  0,
                                  currentValue - 1
                                )
                                setSignItems(updatedItems)
                            ...
                            <Input
                              ...
                              onChange={e => {
                                const updatedItems = [...signItems]
                                const value = parseInt(e.target.value)
                                updatedItems[index].make = isNaN(value)
                                  ? 0
                                  : Math.max(0, value)
                                setSignItems(updatedItems)
                              }}
                        ...
                        <td className='border p-2'>
                          <Input
                            ...
                            onChange={e => {
                              const updatedItems = [...signItems]
                              updatedItems[index].targetDate = e.target.value
                              setSignItems(updatedItems)
                            }}
                          />
                        </td>
        ...
        <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={confirmSaveChanges} disabled={loading}>
        ...
        <Dialog open={showGenerateConfirmDialog} onOpenChange={setShowGenerateConfirmDialog}>
          <DialogContent>
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setShowGenerateConfirmDialog(false)}>
                Cancel
              </Button>
